...
def main_menu_kb() -> InlineKeyboardMarkup:
    buttons = [
        ...
        [
            InlineKeyboardButton(text="📅 Мой день", callback_data="show_day"),
            InlineKeyboardButton(text="💡 Совет", callback_data="recommend"),
        ],
...
def categories_kb(entry: dict) -> InlineKeyboardMarkup:
    ...
    buttons.append([
        InlineKeyboardButton(text="💬 Заметка", callback_data="add_note"),
        InlineKeyboardButton(text="✅ Завершить", callback_data="finish_day"),
    ])
...
def status_kb(category_key: str) -> InlineKeyboardMarkup:
    buttons = [
        ...
        [InlineKeyboardButton(text="🔙 К категориям", callback_data="fill_day")],
    ]
    return InlineKeyboardMarkup(inline_keyboard=buttons)
